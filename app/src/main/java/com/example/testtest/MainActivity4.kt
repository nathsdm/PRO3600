    ...
    private fun processImage(image: Mat) {
        ...
        if (result != null) {
            ...
            if (savedImageUri != null) {
                Toast.makeText(this@MainActivity4, "Image enregistré", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@MainActivity4, "Erreur pour enregistré l'image", Toast.LENGTH_SHORT).show()
            }
        } else {
            imageView.setImageDrawable(null)
            Toast.makeText(this@MainActivity4, "Carte non detecté", Toast.LENGTH_SHORT).show()
        }
    }
